...
import com.example.shixuanyoumei.service.shop.ProductService;
...
public class ProductController {
    ...
    @GetMapping( "/skin" )
    public Result searchHotShopping ( String type ) {
        try {
            List<Shopping> shoppings = productService.SearchtypePeoduct(type) ;
